...
export const projects: ProjectProps[] = [
    ...
    },
    {
        ...
        links: [
            {
                'Github Repository':
                    'https://github.com/melissaharijanto/meltdown',
            },
        ],
    ...
    },
    {
        title: 'Travel Log',
        description:
            'Travel planner app created with React Native, Firebase, and Google Maps API.',
        image: '/travel-log.jpg',
        links: [
            {
                'Project Website':
                    'https://melissharijanto.github.io/Travel-Log',
                'Github Repository':
